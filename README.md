...
```
cd existing_repo
git remote add origin https://git.liacs.nl/s3797457/medimatch.git
git branch -M main
...
- [ ] [Set up project integrations](https://git.liacs.nl/s3797457/medimatch/-/settings/integrations)
