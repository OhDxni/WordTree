...
# Function to open the Tkinter instructions window in a new thread
def open_instructions_window():
    ...
    # Create a Canvas for sky and clouds
    canvas = tk.Canvas(first, width=600, height=400)
    canvas.pack(fill="both", expand=True)

    # Draw the sky (blue rectangle)
    canvas.create_rectangle(0, 0, 600, 400, fill='#87CEFA', outline="")  # Sky blue color

    # Draw clouds (white ovals)
    canvas.create_oval(50, 50, 150, 100, fill="white", outline="")  # Cloud 1
    canvas.create_oval(130, 60, 230, 110, fill="white", outline="")  # Cloud 2
    canvas.create_oval(400, 80, 520, 130, fill="white", outline="")  # Cloud 3
    canvas.create_oval(480, 100, 600, 150, fill="white", outline="")  # Cloud 4

    # Create frames on top of the canvas
    frame1 = tk.Frame(first, bg="white", width=600, height=400)
    frame2 = tk.Frame(first, bg="white", width=600, height=400)
    frame3 = tk.Frame(first, bg="white", width=600, height=400)
    ...
    label1 = tk.Label(frame1, text="Here is how to play:\n\n"
                      ...
                      font=('Comic Sans MS', 14), wraplength=600, bg="white")
    label1.pack(pady=50)
    ...
    label2 = tk.Label(frame2,
                      ...
                      font=('Comic Sans MS', 14), wraplength=500, bg="white")
    label2.pack(pady=50)
...
buttons = [
    ...
    Button(400, 500, 50, "INSTRUCTIONS", font_very_small),
    Button(600, 500, 50, "4-WORDS", font_default),
        ...
        for button in buttons:
            if button.is_clicked(event):
                if button.text == "INSTRUCTIONS":
                    threading.Thread(target=open_instructions_window).start()  # Run Tkinter in a separate thread
                else:
...
#     canvas.pack(fill="both", expand=True)
#
#     # Draw the sky (a blue rectangle covering the whole canvas)
#     canvas.create_rectangle(0, 0, 600, 400, fill='#87CEFA', outline="")  # Sky blue color
#
#     # Draw clouds (white ovals)
#     canvas.create_oval(50, 50, 150, 100, fill="white", outline="")  # Cloud 1
#     canvas.create_oval(130, 60, 230, 110, fill="white", outline="")  # Cloud 2
#     canvas.create_oval(400, 80, 520, 130, fill="white", outline="")  # Cloud 3
#     canvas.create_oval(480, 100, 600, 150, fill="white", outline="")
#
#     frame1 = tk.Frame(canvas, bg="white", width=600, height=400)
#     frame2 = tk.Frame(canvas, bg="white", width=600, height=400)
#     frame3 = tk.Frame(canvas, bg="white", width=600, height=400)
#
#     for frame in (frame1, frame2, frame3):
#         frame.place(x=0, y=0, width=600, height=400)
#
...
#             if button.is_clicked(event):
#                 if button.text == "INSTRUCTIONS":
#                     threading.Thread(target=open_instructions_window).start()
#
#                 else:
#                     print(f"{button.text} clicked!")
#
